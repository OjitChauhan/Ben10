 ...
 <div className='w-screen h-[85vh] overflow-hidden  bg-black flex items-center justify-center flex-col space-y-20'>
  <div className='space-y-5 flex flex-col items-center'>
    ...
    <motion.div whileTap={{opacity:1}} whileInView={{opacity:1}} onClick={()=>setClick(!click)} whileHover={{opacity:1}} className='bg-transparent h-[40px] w-[220px] opacity-75 border-2 border-white flex space-x-2 items-center px-1 py-1 rounded-full'>
                      <div><img src={click?green:red} className='w-[30px] h-[30px] rounded-full' alt="" /></div>
  ...
  <div>
    ...
    className='w-[260px] h-[260px] relative  border-t-transparent border-l-transparent border-r-transparent border-b-transparent border-[4px] rounded-full bg-transparent   flex items-center justify-center'>
      <motion.div animate={{rotate:[0,90,180,240,360]}} transition={{duration:2,repeat:Infinity,ease:'linear'}}
       className='w-[260px] h-[260px] relative border-l-transparent border-[4px] border-r-transparent border-b-transparent   rounded-full bg-transparent  border-[#203354] flex items-center justify-center'>
        <div className='flex items-center absolute  right-5 top-8   w-[20px] h-[20px]   bg-[#AAFF00] rounded-full'> </div>
        </motion.div>
        ...
        <motion.div  animate={{rotate:[0,90,180,240,360]}} transition={{duration:2,repeat:Infinity,ease:'linear'}} className='flex absolute  border-l-transparent border-r-transparent border-[4px] border-t-transparent items-center justify-center w-[210px] border-[6px] h-[210px] border-[#203354]  border-2 rounded-full '>
            <div className='flex items-center absolute  bottom-5 left-4  w-[20px] h-[20px]  bg-orange-800 rounded-full'> </div>
            </motion.div>
             ...
             <motion.div 
             animate={{rotate:[0,90,180,240,360]}} transition={{duration:2,repeat:Infinity,ease:'linear'}}
             ...
             <div className='flex items-center absolute bottom-0 right-[-2px]  w-[20px] h-[20px] bg-red-800  rounded-full'> </div>
                </motion.div>
                  
                  <img src={a[count]}   className='  absolute inset-19  w-[80px] h-[80px] border-[3px] border-[#203354] p-1 rounded-full ' alt="" />
                </div>
             </div>
        </div>
