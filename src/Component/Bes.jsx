...
const Bes = () => {
  ...
  return (
    ...
    <div className='w-screen h-[250px]  bg-opacity-70'>
        <div className='w-full h-full flex items-center justify-center'>
            <div className='w-[80%] relative  flex h-[140px] '>
                <div className='w-[40%] flex justify-center rounded-lg h-full border-[4px] shadow-lg shadow-[#203354] border-[#203354] bg-[#AAFF00]'>
    ...
    <div className='w-screen h-[250px]  bg-opacity-70'>
        <div className='w-full h-full flex items-center justify-center'>
            <div className='w-[80%] relative  flex h-[140px] '>
                <div className='w-[40%] flex justify-center rounded-lg h-full border-[4px] shadow-lg shadow-[#203354] border-[#203354] bg-[#0059b3]'>
